    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-lg">Setcolbd</span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img style="" src="{{asset('employee_images/ceo.jpg')}}" class="img-circle" alt="User Image">
                                    <p>
                                        Admin
                                        <small>http://setcolbd.com/</small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img style="height:50px;width:50px" src="{{asset('employee_images/ceo.jpg')}}" class="img-circle" alt="User Image">
                    </div>
                    <div class="pull-left info">
                     <p style="margin-top:13px">Hridoy</p>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2019 <a href="http://setcolbd.com/">setcolbd</a>.</strong> All rights reserved.
        </footer>
